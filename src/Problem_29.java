...
public class Problem_29 {
    ...
    public static int countDistinctTerms(int maxA, int maxB) {
    ...
    public static void main(String[] args) {
        int distinctCount = countDistinctTerms(100, 100);
        System.out.println("The number of distinct terms for a^b where 2 <= a <= 100 and 2 <= b <= 100 is: " + distinctCount);
    }
}